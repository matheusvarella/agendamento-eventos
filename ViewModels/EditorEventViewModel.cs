...
namespace AgendamentoEventos.ViewModels
{
    public class EditorEventViewModel
    {
        ...
        [Required(ErrorMessage = "O quantidade de ingressos é obrigatória.")]
        [Range(0, 160, ErrorMessage = "O limite é entre 0 e 160 ingressos.")]
        public int TicketLimit { get; set; }
        
        [Required(ErrorMessage = "A descrição é obrigatória.")]
        [StringLength(250, MinimumLength = 2, ErrorMessage = "A descrição deve conter entre 2 e 80 caractéres.")]
